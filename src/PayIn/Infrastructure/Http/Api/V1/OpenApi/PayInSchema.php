...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'origin_account_id', description: 'Cuenta del usuario que envía (se debita)', type: 'string', format: 'uuid', example: '019fd715-ec1a-7a7e-ab6f-f497aa52abe4'),
        new OA\Property(property: 'account_id', description: 'Cuenta del usuario que recibe (se abona)', type: 'string', format: 'uuid', example: '019fd715-ec22-700c-8cba-ea026d0fd9a9'),
