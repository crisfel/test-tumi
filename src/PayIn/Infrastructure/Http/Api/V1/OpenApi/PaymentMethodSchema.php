...
#[OA\Schema(
    ...
    required: ['id', 'account_id', 'provider_id', 'type', 'details_masked', 'is_active', 'created_at'],
    properties: [
        new OA\Property(property: 'id', type: 'string', format: 'uuid', example: '019fd715-ec43-784b-97dd-9b2fe70bfe69'),
        new OA\Property(property: 'account_id', type: 'string', format: 'uuid', example: '019fd715-ec1a-7a7e-ab6f-f497aa52abe4'),
        new OA\Property(property: 'provider_id', type: 'string', format: 'uuid', example: '019fd715-eb24-7683-b8d2-9d83ffdca22d'),
        new OA\Property(property: 'type', type: 'string', enum: ['card', 'bank_transfer', 'wallet', 'pse'], example: 'card'),
