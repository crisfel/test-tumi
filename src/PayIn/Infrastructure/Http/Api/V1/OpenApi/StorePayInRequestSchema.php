 ...
 * el usuario que envía paga con su tarjeta y el dinero llega a la cuenta del
 * usuario que recibe.
 */
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'client_id', description: 'UUID del cliente que envía dinero — su cuenta de origen se debita', type: 'string', format: 'uuid', example: '019fd715-ebf8-7223-ada8-b3c168a28e22'),
        new OA\Property(property: 'origin_account_id', description: 'UUID de la cuenta de ORIGEN del que envía (COP, saldo 100.000): se DEBITA el monto', type: 'string', format: 'uuid', example: '019fd715-ec1a-7a7e-ab6f-f497aa52abe4'),
        new OA\Property(property: 'account_id', description: 'UUID de la cuenta DESTINO del que recibe (COP, saldo 0): se ACREDITA el monto', type: 'string', format: 'uuid', example: '019fd715-ec22-700c-8cba-ea026d0fd9a9'),
        new OA\Property(property: 'payment_method_id', description: 'UUID del método de pago (tarjeta de FakePay)', type: 'string', format: 'uuid', example: '019fd715-ec43-784b-97dd-9b2fe70bfe69'),
