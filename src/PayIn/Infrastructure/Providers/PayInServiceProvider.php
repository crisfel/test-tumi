...
use PayIn\Infrastructure\Persistence\Eloquent\Repositories\EloquentAccountMovementRepository;
...
final class PayInServiceProvider extends ServiceProvider
{
    ...
    private function registerPersistence(): void
    {
        ...
        $this->app->bind(AccountMovementRepository::class, EloquentAccountMovementRepository::class);

        $this->app->bind(ClientMapper::class);
        $this->app->bind(AccountMapper::class);
        $this->app->bind(AccountMovementMapper::class);
